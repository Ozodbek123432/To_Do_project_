"""
Django settings for BooC_Home project.
...
SECRET_KEY = 'django-insecure-el$p(vwzxi_i!+-pwcs=+dz^!mtz5ry0mn(0^rl4)8kd^^zpu_'
...
WSGI_APPLICATION = 'BooC_Home.wsgi.application'
